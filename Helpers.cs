...
namespace Advantage.API
{
    public class Helpers
    {
        ...
        internal static string MakeUsername()
        {
            var prefix = GetRandom(givenName);
            var suffix = GetRandom(surName);

            return prefix+ " " + suffix;
        }

        private  static readonly List<string> givenName = new List<string>()
        {
